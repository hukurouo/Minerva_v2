...
def get_jockey(id, agent)
  ...
  jockey_map = {}
  table.each_with_index do |t,i| 
    score = t.css('td')[10].text.strip.split("%")[0]
...
def write(race_result)
  CSV.open("today/2021/valid-padoc-train-data-add.csv", "a") do |csv| 
...
def main 
  agent = login()
  race_ids_pre = [
    "202106030509","202109020509","202104010109",
    "202106030609",
    "202109020609","202104010209",
    "202106030709","202109020709","202104010309",
    "202106030809",
    "202109020809","202104010409",
    "202105020109","202109020909","202104010509",
    "202105020209","202109021009","202104010609",
    "202105020309","202109021109","202104010709",
    "202105020409","202109021209","202104010809",
    "202105020509","202107030109","202104020109",
    "202105020609","202107030209","202104020209",
    "202105020709","202107030309","202104020309",
    "202105020809","202107030409","202104020409",
    "202105020909","202107030509","202104020509",
    "202105021009","202107030609","202104020609",
    "202105021109","202107030709",
    "202105021209","202107030809",
    "202105030109","202107040109",
    "202105030209","202107040209",
    "202105030309","202107040309","202101010109",
    "202105030409","202107040409","202101010209",
    "202105030509","202109030109","202101010309",
    "202105030609","202109030209","202101010409",
  ]
  race_ids = []
  race_ids_pre.each do |r|
    (0..3).each do |i|
      race_ids << (r.to_i + i).to_s
    end
  end
  original_map = {}
  original_data = CSV.table("today/2021/valid-padoc-train-data.csv", {:encoding => 'UTF-8', :converters => nil})
  ...
  race_ids.each_with_index do |id, index|
    ...
    frame_map.each do |key,value|
      #id,raceName,horseNumber,horseName,jockeyPoint,stallionPoint,trainerPoint,timePoint,resultPoint,timeDiffPoint,oikiri,comment,padoc
      #id,horseId,framePoint,kyakuPoint,timePoint,rankPoint,tyakusaPoint
      ...
      csv_row << value
      csv_row << kyaku_map[key]
      csv_row << time_map[key]
      csv_row << result_map[key][:rank]
      csv_row << result_map[key][:tyakusa]
      #csv_row = [
      #  id,
      #  key,
      #  #jockey_map[key],
