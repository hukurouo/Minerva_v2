...
def normalize_datas(place)
  raw_datas = CSV.table("intermediate/datas/#{place}/raw_datas.csv", {:encoding => 'UTF-8', :converters => nil})
  ...
  n_datas = ["id,horseId,horseNumber,jockeyPointTop,stallionPointTop,trainerPointTop,framePointTop,kyakuPointTop,oikiri,comment,timePointTop,rankPoint,tyakusaPoint".split(",")]
  ...
  CSV.open("intermediate/datas/#{place}/n_datas_ad.csv", "w") do |csv| 
